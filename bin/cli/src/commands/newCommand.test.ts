...
describe("Package validation", () => {
  ...
  test("Should return InvalidArgumentError: contains illegal character", () => {
    expect(validate("my/illegal.app")).toEqual(new InvalidArgumentError("Invalid project name. Project name must start with alpha-numeric value, and can only contains letters, numbers, hyphens, and underscores"));
  });
});
