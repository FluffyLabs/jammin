 ...
 */
import { config, JamTest, ServiceId } from "${SDK_PACKAGE_NAME}";
...
/**
 * Pre-configured high-level test instance with all services loaded in genesis state
 */
export const testJam = await JamTest.create();
`;
}
